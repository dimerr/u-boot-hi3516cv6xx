...
typedef struct {
    ...
    union {
        ot_vo_auto_user_sync_info auto_user_sync_info; /* RW; auto user synchronization info */
        ot_vo_manual_user_sync_info manual_user_sync_info; /* RW; manual user synchronization info */
    };
