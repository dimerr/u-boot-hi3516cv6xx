...
{
    (td_void)memset_s(rgb_param, sizeof(ot_vo_rgb_param), 0, sizeof(ot_vo_rgb_param));
    ...
    rgb_param->rgb_dummy_out_en = TD_FALSE;
    rgb_param->rgb_dummy_order = OT_VO_DUMMY_ORDER_DUMMY_RGB;
    rgb_param->gamma_info.gamma_enable = TD_FALSE;
}
#endif
...
{
    (td_void)memset_s(mipi_param, sizeof(ot_vo_mipi_param), 0, sizeof(ot_vo_mipi_param));
    ...
    mipi_param->gamma_info.gamma_enable = TD_FALSE;
}
#endif
