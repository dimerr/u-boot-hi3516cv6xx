...
td_void sys_hal_acodec_apb_clk_en(td_bool clk_en)
{
    ...
    ot_reg_set_bit(tmp, 4, io_address(CRG_PERCTL10912_ADDR)); /* 4: bit */
}
...
{
    audio_clk_info->mclk_div_48k_256fs = AIO_MCLK_48K_256FS_2376M;
    audio_clk_info->mclk_div_44p1k_256fs = AIO_MCLK_44P1K_256FS_2376M;
    audio_clk_info->mclk_div_32k_256fs = AIO_MCLK_32K_256FS_2376M;

    audio_clk_info->mclk_div_48k_320fs = AIO_MCLK_48K_320FS_2376M;
    audio_clk_info->mclk_div_44p1k_320fs = AIO_MCLK_44P1K_320FS_2376M;
    audio_clk_info->mclk_div_32k_320fs = AIO_MCLK_32K_320FS_2376M;

    audio_clk_info->mclk_div_96k_256fs = AIO_MCLK_96K_256FS_2376M;
    audio_clk_info->mclk_div_88p2k_256fs = AIO_MCLK_88P2K_256FS_2376M;
    audio_clk_info->mclk_div_64k_256fs = AIO_MCLK_64K_256FS_2376M;

    audio_clk_info->mclk_div_192k_256fs = AIO_MCLK_192K_256FS_2376M;
    audio_clk_info->mclk_div_176p4k_256fs = AIO_MCLK_176P4K_256FS_2376M;
    audio_clk_info->mclk_div_128k_256fs = AIO_MCLK_128K_256FS_2376M;
}

static td_void clk_select_spare(aiao_clk_info *audio_clk_info)
{
    audio_clk_info->mclk_div_48k_256fs = AIO_MCLK_48K_256FS_1900M;
    audio_clk_info->mclk_div_44p1k_256fs = AIO_MCLK_44P1K_256FS_1900M;
    audio_clk_info->mclk_div_32k_256fs = AIO_MCLK_32K_256FS_1900M;

    audio_clk_info->mclk_div_48k_320fs = AIO_MCLK_48K_320FS_1900M;
    audio_clk_info->mclk_div_44p1k_320fs = AIO_MCLK_44P1K_320FS_1900M;
    audio_clk_info->mclk_div_32k_320fs = AIO_MCLK_32K_320FS_1900M;

    audio_clk_info->mclk_div_96k_256fs = AIO_MCLK_96K_256FS_1900M;
    audio_clk_info->mclk_div_88p2k_256fs = AIO_MCLK_88P2K_256FS_1900M;
    audio_clk_info->mclk_div_64k_256fs = AIO_MCLK_64K_256FS_1900M;

    audio_clk_info->mclk_div_192k_256fs = AIO_MCLK_192K_256FS_1900M;
    audio_clk_info->mclk_div_176p4k_256fs = AIO_MCLK_176P4K_256FS_1900M;
    audio_clk_info->mclk_div_128k_256fs = AIO_MCLK_128K_256FS_1900M;
}
