...
#define ACODEC_ANAREG0_DEFAULT 0x1C1CFFFF
#define ACODEC_ANAREG1_DEFAULT 0xDF605E65
#define ACODEC_ANAREG2_DEFAULT 0x0025550C
...
typedef union {
    struct {
        ...
        unsigned int    vref_pd_res_sel_b8_b11 : 4; /* [11..8]  */
        unsigned int    rctune_mode_sel       : 1; /* [12]  */
        unsigned int    rctune_i_sel          : 2;  /* [14..13]  */
        unsigned int    reserved_1            : 1; /* [15]  */
        unsigned int    vref_pd_res_sel_b0_b7 : 8; /* [23..16]  */
