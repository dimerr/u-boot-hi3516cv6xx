...
#if defined(CONFIG_TRNG_GET_RANDOM_SUPPORT)
...
#if defined(CONFIG_TRNG_GET_MULTI_RANDOM_SUPPORT)
...
#if defined(CONFIG_SYMC_SUPPORT)
...
#else
    { CRYPTO_CMD_HASH_INIT,                     NULL },
    { CRYPTO_CMD_HASH_DEINIT,                   NULL },
    { CRYPTO_CMD_HASH_START,                    NULL },
    { CRYPTO_CMD_HASH_UPDATE,                   NULL },
    { CRYPTO_CMD_HASH_FINISH,                   NULL },
#endif
#if defined(CONFIG_HASH_CLONE_SUPPORT)
...
#else
    { CRYPTO_CMD_TRNG_GET_RANDOM,               NULL },
#endif
#if defined(CONFIG_TRNG_GET_MULTI_RANDOM_SUPPORT)
    { CRYPTO_CMD_TRNG_GET_MULTI_RANDOM,         dispatch_trng_get_multi_random },
#else
    { CRYPTO_CMD_TRNG_GET_MULTI_RANDOM,         NULL },
#endif
#if defined(CONFIG_SYMC_SUPPORT)
...
#else
    { CRYPTO_CMD_SYMC_INIT,                     NULL },
    { CRYPTO_CMD_SYMC_DEINIT,                   NULL },
    { CRYPTO_CMD_SYMC_CREATE,                   NULL },
    { CRYPTO_CMD_SYMC_DESTROY,                  NULL },
    { CRYPTO_CMD_SYMC_SET_CONFIG,               NULL },
#endif
#if defined(CONFIG_SYMC_GET_CONFIG_SUPPORT)
...
#else
    { CRYPTO_CMD_SYMC_ENCRYPT,                  NULL },
    { CRYPTO_CMD_SYMC_DECRYPT,                  NULL },
#endif
