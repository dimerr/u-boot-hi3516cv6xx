...
#endif
    crypto_chk_return(mac_attr->work_mode != CRYPTO_SYMC_WORK_MODE_CBC_MAC &&
        mac_attr->work_mode != CRYPTO_SYMC_WORK_MODE_CMAC, SYMC_COMPAT_ERRNO(ERROR_INVALID_PARAM), "mode is invalid\n");
