...
otp_val g_otp_fields_big_endian_num[] = {
	...
	// { "oem_rootkey1", 128, LOCKABLE, 0xd0, 0, "" },
	// { "oem_rootkey2", 128, LOCKABLE, 0xe0, 0, "" },
	...
	// { "sdio0_selfboot_disable", 1, ONEWAY, 0x1e1, 3, "" },
	// { "sdio1_selfboot_disable", 1, ONEWAY, 0x1e1, 6, "" },
	// { "usb_selfboot_disable", 1, ONEWAY, 0x1e1, 5, "" },
