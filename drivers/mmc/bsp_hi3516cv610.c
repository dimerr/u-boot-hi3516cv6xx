...
/* CRG register */
#define PERI_CRG_MMC_CLK            (CRG_REG_BASE + 0x35c0)
#define PERI_CRG_SDIO0_CLK          (CRG_REG_BASE + 0x36c0)
...
#define PERI_CRG_MMC_P4_DLL         (CRG_REG_BASE + 0x35c4)
#define CRG_P4_DLL_SRST_REQ         BIT(1)

#define PERI_CRG_MMC_DRV_DLL        (CRG_REG_BASE + 0x35c8)
#define PERI_CRG_SDIO0_DRV_DLL      (CRG_REG_BASE + 0x36c8)
#define CRG_DRV_PHASE_SEL_SHIFT     15
#define CRG_DRV_PHASE_SEL_MASK      (0x1F << CRG_DRV_PHASE_SEL_SHIFT)

#define PERI_CRG_MMC_STAT           (CRG_REG_BASE + 0x35d8)
#define PERI_CRG_SDIO0_STAT         (CRG_REG_BASE + 0x36d8)
...
#define REG_EMMC_SAMPLB_DLL_CTRL    0x35d4
#define REG_SDIO0_SAMPLB_DLL_CTRL   0x36d4
...
/* SDIO0 IO */
#define REG_SD_IO_CFG_BASE  REG_MMC_IO_CFG_BASE
#define REG_SDIO0_PWEN_N    0x54
#define REG_SDIO0_CMD_IO    0x40
#define REG_SDIO0_D0_IO     0x48
#define REG_SDIO0_D1_IO     0x4c
#define REG_SDIO0_D2_IO     0x38
#define REG_SDIO0_D3_IO     0x3c
#define REG_SDIO0_CLK_IO    0x44
...
static void emmc_pin_mux_config(void)
{
	...
	set_pin_mux(REG_MMC_CMD_IO, IO_MUX_FUNC2);
	for (i = 0; i < bus_width; i++)
		set_pin_mux(reg_data_io[i], IO_MUX_FUNC2);
	set_pin_mux(REG_MMC_RSTN_IO, IO_MUX_FUNC1);

	if (bus_width == MMC_BUS_WIDTH_8_BIT)
		set_pin_mux(REG_MMC_DQS_IO, IO_MUX_FUNC2);
}
