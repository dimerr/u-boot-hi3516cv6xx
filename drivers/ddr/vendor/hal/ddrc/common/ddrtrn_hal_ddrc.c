...
@param      flag         flag to enable DMC DDRPHY CKG_EN.
                                    ...
                                    1: disable
**/
void ddrtrn_hal_dmc_ddrphy_ckg_en_cfg(unsigned int base_dmc, unsigned int flag)
{
	ddr_dmc_ddrphy_ckg_desc reg;

	reg.val = ddrtrn_reg_read(base_dmc + DDR_DMC_DDRPHY_CKG);
	reg.bits.acphy_cmd1t2t_ckg_en = flag;
	reg.bits.ddrphy_dficlk_ckg_en = flag;
	ddrtrn_reg_write(reg.val, base_dmc + DDR_DMC_DDRPHY_CKG);
}
...
@param      flag         flag to enable DMC DDRPHY AC_OE_EN.
                                    ...
                                    1: disable
**/
void ddrtrn_hal_dmc_ddrphy_ac_io_oe_en_cfg(unsigned int base_dmc, unsigned int flag)
{
	ddr_dmc_ddrphy_ac_oe_desc reg;

	reg.val = ddrtrn_reg_read(base_dmc + DDR_DMC_DDRPHY_AC_OE);
	reg.bits.ddrphy_cs_io_oe_en = flag;
	reg.bits.ddrphy_cmd2t_io_oe_en = flag;
	ddrtrn_reg_write(reg.val, base_dmc + DDR_DMC_DDRPHY_AC_OE);
}
...
@param      flag         flag to enable DMC DDRPHY AC_OE_EN.
                                    ...
                                    1: disable
**/
void ddrtrn_hal_dmc_ckg_en_cfg(unsigned int base_dmc, unsigned int flag)
{
	ddr_dmc_ckg_desc reg;

	reg.val = ddrtrn_reg_read(base_dmc + DDR_DMC_CKG);
	reg.bits.cmd_path_ckg_en = flag;
	reg.bits.dmc_aref_ckg_en = flag;
	reg.bits.dmc_pd_ckg_en = flag;
	ddrtrn_reg_write(reg.val, base_dmc + DDR_DMC_CKG);
}
