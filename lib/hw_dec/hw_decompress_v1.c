...
#if (defined CONFIG_TARGET_HI3516CV610_FAMILY)
#include "hw_decompress_hi3516cv610.c"
#endif
...
void hw_dec_sop_eop_first_set(unsigned int block_num)
{
	if (block_num == 1) {
		hw_dec_sop = 1;
		hw_dec_eop = 1;
...
static void hw_dec_intr_en_set(unsigned int blk_intr_en, unsigned int task_intr_en)
{
	u_intr_en intr_en;
