...
static int do_ufs_read(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	u32 blk, cnt;
	u64 addr;
...
static int do_ufs_write(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	u32 blk, cnt;
	u64 addr;
	unsigned long long start_ticks, end_ticks;
...
static int do_ufs_bootread(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	u32 blk, cnt;
	u64 addr;
...
static int do_ufs_bootwrite(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	u32 blk, cnt;
	u64 addr;
...
static int do_ufs_reinit(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	if (argc != 2) /* 2 arg */
		return CMD_RET_USAGE;
...
static int do_ufs_reg(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	if (argc != 2) /* 2 arg */
		return CMD_RET_USAGE;
...
static int do_ufs_setlun(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	u32 lun_num;
...
static int do_ufs_bootlun(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	u32 lun_num;
...
static int do_ufs_hi(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	int ret;
...
static int do_ufs_ho(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	int ret;
...
static int do_ufs_mode(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
...
static int do_ufsinfo(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	u32 type;
